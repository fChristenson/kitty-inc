...
// raw src/assets/isometricYarn.jfif (AI-generated: a flat cartoon isometric ball of
// yarn on a plain white background) gets border-flood-fill chroma-keyed to
// transparent (same technique as process-isometric-box.mjs/process-star.mjs/
// process-coin.mjs/process-roof.mjs/process-mouse.mjs), then cropped to its own
// tight bounding box. Writes to src/assets/isometricYarn.png; never overwrites the
// raw source.
...
const src = path.join(assets, "isometricYarn.jfif");
const dest = path.join(assets, "isometricYarn.png");
