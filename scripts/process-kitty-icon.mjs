...
// raw src/assets/kitty1.png (AI-generated: a cute cat in a business suit, facing the
// camera, on a plain white background) gets border-flood-fill chroma-keyed to
// transparent (same technique as process-coin.mjs/process-mouse.mjs), then cropped to
// its own tight bounding box. Writes to src/assets/kittyIcon.png; never overwrites the
// raw source.
...
const src = path.join(assets, "kitty1.png");
const dest = path.join(assets, "kittyIcon.png");
