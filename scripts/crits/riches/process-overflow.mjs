...
// Overflow's raw art uses a near-white rendered background. A border-seeded
// flood fill preserves the enclosed dark artwork while removing that background.
const WHITE_LO = 195;
const WHITE_HI = 235;
const FLOOD_LO = 195;
const assets = path.resolve(import.meta.dirname, "../../..", "src", "assets", "crits", "riches");
const src = path.join(assets, "overflow.jfif");
const dest = path.join(assets, "overflow.png");
...
function firstOpaque(rows, cols, get) {
