...
const source = path.resolve(import.meta.dirname, "../../../src/assets/crits/gear/potionCommotion.jfif");
const destination = path.resolve(import.meta.dirname, "../../../public/crits/gear/potionCommotion.png");
