...
// Dress Code uses the same light, rendered background treatment as the other
// office-themed crit icons: flood-fill the border so enclosed light details survive.
const WHITE_LO = 195;
const WHITE_HI = 235;
const FLOOD_LO = 195;
