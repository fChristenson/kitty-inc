...
// Safety Net's near-white photographic background is removed from the border
// inward, preserving the enclosed net and orange center details.
const WHITE_LO = 195;
const WHITE_HI = 235;
const FLOOD_LO = 195;
const assets = path.resolve(import.meta.dirname, "../../..", "src", "assets", "crits", "office");
const src = path.join(assets, "safetyNet.jfif");
const dest = path.join(assets, "safetyNet.png");
