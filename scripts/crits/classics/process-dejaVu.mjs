...
// Process the raw Deja Vu crit artwork into a transparent, tightly-cropped,
// palette-quantized backdrop icon. The source uses a near-white background.
const WHITE_LO = 220;
const WHITE_HI = 245;
const FLOOD_LO = 220;

const assets = path.resolve(import.meta.dirname, "../../..", "src", "assets", "crits", "classics");
const src = path.join(assets, "dejaVu.jfif");
const dest = path.join(assets, "dejaVu.png");
