...
const src = path.join(assets, "luckyClover.jfif");
const dest = path.join(assets, "luckyClover.png");
...
await sharp(shadowed.data, { raw: { width: shadowed.width, height: shadowed.height, channels: 4 } })
