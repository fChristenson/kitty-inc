...
try {
  ...
  const expected = {
    ...
    theCatfather: [[20, 53, 10, 0], 0],
    unrefusableOffer: [[20, 30, 10, 0], 186],
    briefcaseBonus: [[20, 62, 10, 0], 102],
    violinCaseCaper: [[20, 30, 10, 0], 177],
    technicolorTake: [[20, 30, 10, 0], 276],
    stringsAttached: [[72, 30, 62, 0], 0],
    fiddlesticksFund: [[20, 30, 10, 0], 159],
    fedoraFlex: [[20, 91, 10, 0], 0],
    brimTipper: [[20, 90, 10, 0], 0],
    greenbackFan: [[20, 58, 10, 0], 93],
    craftyConsigliere: [[20, 71, 51, 0], 0],
    cappuccinoCapo: [[67, 77, 10, 0], 0],
    demitasseDues: [[20, 30, 10, 0], 196],
    latteLoyalty: [[20, 30, 65, 0], 0],
    takeTheCannoli: [[20, 30, 10, 0], 122],
    speakeasyStash: [[20, 30, 67, 0], 0],
    passwordPlease: [[20, 30, 10, 0], 116],
    hiddenDoorHaul: [[78, 30, 10, 0], 0],
    pinstripePension: [[63, 73, 53, 0], 0],
    lipsSealed: [[20, 30, 10, 0], 63],
    protectionRacket: [[20, 73, 53, 0], 0],
    runningBoardRiches: [[73, 30, 10, 0], 0],
    sundaySauceSitdown: [[40, 50, 30, 0], 114],
    kissTheRing: [[20, 66, 10, 0], 0],
    bootlegBarrel: [[20, 30, 10, 0], 64],
    wiseguySwagger: [[58, 68, 10, 0], 0],
    dontWorryAboutIt: [[20, 30, 39, 0], 66],
    mindYourOwnBusiness: [[46, 30, 36, 0], 90],
    oyabunsBlessing: [[20, 68, 10, 0], 0],
    irezumiInk: [[20, 93, 10, 0], 0],
    teboriTabby: [[20, 30, 10, 0], 183],
    indigoInkwell: [[20, 63, 10, 0], 105],
    dragonBackpiece: [[20, 50, 10, 0], 0],
    dragonPearlPact: [[20, 30, 10, 0], 192],
    gingerDragon: [[20, 92, 10, 0], 0],
    katanaCashflow: [[70, 80, 10, 0], 0],
    samuraiSpillway: [[20, 30, 10, 0], 204],
    goldenKoiClan: [[74, 30, 64, 0], 0],
    koiCoinWhirlpool: [[20, 30, 10, 0], 168],
    manekiMobster: [[20, 30, 10, 0], 288],
    hanafudaHeist: [[20, 30, 10, 0], 66],
    hannyaMuscle: [[20, 95, 10, 0], 0],
    redMaskGuard: [[20, 30, 69, 0], 0],
    maskedRetainer: [[20, 30, 10, 0], 120],
    blackSedanConvoy: [[75, 30, 10, 0], 0],
    pompadourPosse: [[64, 74, 54, 0], 0],
    sakazukiOath: [[20, 30, 10, 0], 200],
