...
// dir (a theme's own src/assets/<name>/ folder, where raw AI uploads live)
// and its dist dir (src/assets/<name>/dist/, the ready-to-use output every
...
export function resolveThemeDirs(assetsDir) {
  ...
  const themeDir = assetsDir;
  const distDir = path.resolve(assetsDir, "..", "public", "assets");
