...
// raw src/assets/manager.jfif (AI-generated: a cute cat in a business suit and
// round glasses, facing the camera, on a plain white background) gets
// border-flood-fill chroma-keyed to transparent (same technique as
// process-kitty-icon.mjs/process-coin.mjs/process-mouse.mjs), then cropped to its
// own tight bounding box. Writes to src/assets/managerIcon.png; never overwrites
// the raw source.
...
const src = path.join(assets, "manager.jfif");
const dest = path.join(assets, "managerIcon.png");
