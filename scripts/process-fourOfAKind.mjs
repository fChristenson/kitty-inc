...
// raw src/assets/fourOfAKind.jfif (AI-generated: four fanned "9" playing
// cards \u2014 hearts, spades, clubs, diamonds \u2014 on a plain light-gray
...
// pick for a fanned multi-card scene), cropped to its own tight bounding box,
// given a synthesized drop shadow, and palette-quantized. Writes to
// src/assets/fourOfAKind.png; never overwrites the raw source.
const WHITE_LO = 170;
const WHITE_HI = 220;
const FLOOD_LO = 170;
...
const src = path.join(assets, "fourOfAKind.jfif");
const dest = path.join(assets, "fourOfAKind.png");
