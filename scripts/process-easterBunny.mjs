...
// raw src/assets/easterBunny.jfif (AI-generated: a cartoon bunny holding an
// egg on a solid flat gray background) — same "solid flat non-white
// background" shape as booty.jfif/explosion.jfif, so this reuses that same
// global-distance-from-background-color threshold instead of a whiteness
// threshold. Writes to src/assets/easterBunny.png; never overwrites the raw
// source.
const BG_COLOR = [183, 184, 183];
const DIST_LO = 15; // below this distance from BG_COLOR: fully transparent
const DIST_HI = 50; // above this distance: fully opaque

const assets = path.resolve(import.meta.dirname, "..", "src", "assets");
const src = path.join(assets, "easterBunny.jfif");
const dest = path.join(assets, "easterBunny.png");
