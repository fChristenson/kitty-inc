...
// raw src/assets/fullHouse.jfif (AI-generated: five fanned playing cards on a
// plain light-gray background) gets border-flood-fill chroma-keyed to
...
// src/assets/fullHouse.png; never overwrites the raw source.
const WHITE_LO = 170;
const WHITE_HI = 220;
const FLOOD_LO = 170;
...
const src = path.join(assets, "fullHouse.jfif");
const dest = path.join(assets, "fullHouse.png");
