...
// the art is drawn sticker-style, with a white stroke wrapping the black
// outline; the border-seeded fill strips that ring along with the page, while
// the cream muzzle, face stripes and spear blade stay opaque behind outlines
// the fill can't cross
const WHITE_LO = 195;
const WHITE_HI = 235;
const FLOOD_LO = 195;
const assets = path.resolve(import.meta.dirname, "..", "src", "assets");
const src = path.join(assets, "headhunter.jfif");
const dest = path.join(assets, "headhunter.png");
...
// the cat's paw wraps the spear shaft, so the whole scene is one blob
