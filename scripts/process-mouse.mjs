...
// raw src/assets/mouse.jfif (AI-generated: a cute round cartoon mouse, facing left,
// on a plain white background) gets border-flood-fill chroma-keyed to transparent
// (same technique as process-roof.mjs/process-clouds.mjs), then cropped to its own
// tight bounding box. Writes to src/assets/mouse.png; never overwrites the raw source.
...
const src = path.join(assets, "mouse.jfif");
const dest = path.join(assets, "mouse.png");
...
// it as content — same fix process-roof.mjs needed
