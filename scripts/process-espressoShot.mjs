...
// Process the raw Espresso Shot crit artwork into a transparent,
// tightly-cropped, palette-quantized backdrop icon. The source uses a
// near-white background and the icon is only drawn at flash-text scale.
const WHITE_LO = 220;
const WHITE_HI = 245;
const FLOOD_LO = 220;

const assets = path.resolve(import.meta.dirname, "..", "src", "assets");
const src = path.join(assets, "expressoShot.jfif");
const dest = path.join(assets, "espressoShot.png");
