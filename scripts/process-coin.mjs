...
// raw src/assets/coin.jfif (AI-generated: a glossy gold cartoon coin on a plain
...
// bounding box. Writes to src/assets/coin.png; never overwrites the raw source.
...
const src = path.join(assets, "coin.jfif");
const dest = path.join(assets, "coin.png");
