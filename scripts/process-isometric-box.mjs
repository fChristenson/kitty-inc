...
// raw src/assets/isometricBox.jfif (AI-generated: a flat cartoon isometric
// cardboard box on a plain white background) gets border-flood-fill chroma-keyed
// to transparent (same technique as process-star.mjs/process-coin.mjs/
// process-roof.mjs/process-mouse.mjs), then cropped to its own tight bounding box.
// Writes to src/assets/isometricBox.png; never overwrites the raw source.
...
const src = path.join(assets, "isometricBox.jfif");
const dest = path.join(assets, "isometricBox.png");
