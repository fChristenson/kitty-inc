...
// raw src/assets/shield.jfif (AI-generated: a gold/blue cartoon shield icon on a
// plain white background) gets border-flood-fill chroma-keyed to transparent
// (same technique as process-coin.mjs/process-mouse.mjs), then cropped to its own
// tight bounding box. Writes to src/assets/shield.png; never overwrites the raw source.
...
const src = path.join(assets, "shield.jfif");
const dest = path.join(assets, "shield.png");
...
// it as content — same fix process-coin.mjs/process-mouse.mjs needed
