...
// the cats' white highlight streaks are sealed behind their own heavy outline,
// so the border-seeded fill can't reach them and the thresholds can sit low
// enough to also eat the ragged pale sketch rim drawn around the pile
const WHITE_LO = 195;
const WHITE_HI = 235;
const FLOOD_LO = 195;
const assets = path.resolve(import.meta.dirname, "..", "src", "assets");
// note the raw art's own filename is all-lowercase, unlike the shipped PNG
const src = path.join(assets, "teambuilding.jfif");
const dest = path.join(assets, "teamBuilding.png");
...
// the three cats are drawn as one cuddled pile inside a single outline
