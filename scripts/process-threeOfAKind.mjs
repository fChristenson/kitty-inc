...
// raw src/assets/threeOfAKind.jfif (AI-generated: three fanned Ace playing
// cards \u2014 hearts, spades, clubs \u2014 on a plain light-gray background) gets
...
// keepLargestOpaqueComponent, is the right pick for a fanned multi-card
// scene), cropped to its own tight bounding box, given a synthesized drop
// shadow, and palette-quantized. Writes to src/assets/threeOfAKind.png;
...
const src = path.join(assets, "threeOfAKind.jfif");
const dest = path.join(assets, "threeOfAKind.png");
