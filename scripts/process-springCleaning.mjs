...
// the cat's cream belly/muzzle falls inside these thresholds, so the fill is
// border-seeded rather than applied per-pixel — it can't cross the heavy
// outline to reach it. Kept low enough to also eat the ragged pale sketch rim
const WHITE_LO = 195;
const WHITE_HI = 235;
const FLOOD_LO = 195;
...
// the cat holds the broom, so the whole scene is one opaque blob
