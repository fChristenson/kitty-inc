...
// Floor Share's near-white photographic background is removed from the border
// inward so enclosed light details remain part of the icon.
const WHITE_LO = 195;
const WHITE_HI = 235;
const FLOOD_LO = 195;
const assets = path.resolve(import.meta.dirname, "..", "src", "assets");
const src = path.join(assets, "floorShare.jfif");
const dest = path.join(assets, "floorShare.png");
